...
?>
<center><h2><font color="red"><b>Выплаты Закрыты До Следующего Сезона Игры<b></h2></font></center><BR />
                        ...
                        if($db->FetchRow() == 0){
                            ...
                            if ($payeer->isAuth())
                            {
                                ...
                                if($arBalance["auth_error"] == 0)
                                {
                                    ...
                                    'comment' => iconv('windows-1251', 'utf-8', "Выплата пользователю {$usname} с проекта Рэперы")
