...
?>
<div class="s-bk-lf">
	<div class="acc-title"><font color = '#0000ff'>Лотерея</div>
</div>
<div class="silver-bk">
...
</font><font color = '#0000FF'><h3>Лотерея - это такая игра. Всего имеется <?=$num_bil; ?> билетов. После того, как все билеты будут проданы состоится розыгрыш счастливых билетов. Система случайным образом выберет 3 номера счастливых билетов и зачислит им призы. </h3><BR />
<h3>1 место - 50% от общего банка [<?=($amount_lottery * $num_bil) * 0.5; ?> серебра]. <BR />
...
Остальные 5% составляют комиссию системы.</h3>
<BR />
<u><h3>Стоимость билета = <?=$amount_lottery; ?> серебра</u>.</h3>
<BR />
<BR /><BR />
