<div class="s-bk-lf">
	<div class="acc-title"><font color = '#0000ff'>Обменник</div>
</div>
<?PHP
...
?>  
<div class="silver-bk"><font color = '#000000'><h3>В обменном пункте Вы можете обменять серебро для вывода на серебро для покупок. 
При обмене серебра Вы получаете +<?=$sonfig_site["percent_swap"]; ?>% на счет для покупок.<br /><br />
<center><font color="red">Обмен возможен только в одну сторону</font></p></center></h3>
...
$sum = intval($_POST["sum"]);
	...
	}else echo "<center><font color = 'red'><b>Минимальная сумма для обмена 500 серебра</b></font></center><BR />";
...
<table width="400" border="0" align="center">
  <tr>
    <td><font color="#000;"><h3>Отдаете серебро для вывода</font> [мин. 500]: </td></h3>
    <td align="center"><input type="text" class="lg" name="sum" id="sum" value="500" onkeyup="GetSumPer();" style="margin:0px; width:60px;"/></td>
  </tr>
  <tr>
    <td><font color="#000;"><h3>Получаете серебро для покупок</font> [+<?=$sonfig_site["percent_swap"]; ?>%]: </td></h3>
