...
$_OPTIMIZATION["description"] = "Заработай на Реперах";
...
@include("inc/_header.php");
		...
		if(isset($_GET["menu"])){
			...
			switch($menu){
				...
				case "top10": include("pages/_top10.php"); break; // Новости
				...
				case "mon": include("pages/_mon.php"); break; // Топ
